...
-- CreateIndex
CREATE INDEX "Availibility_doctorId_startTime_idx" ON "Availibility"("doctorId", "startTime");
...
-- AddForeignKey
ALTER TABLE "Availibility" ADD CONSTRAINT "Availibility_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
